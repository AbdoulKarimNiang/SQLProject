...
-- for any employee in the Employee table. Write a query 
...
-- number of months they've been working for the company,
...
-- so we print the maximum earnings value (69952) and a count of the number of employees
-- who have earned $69952 (which is 1 ) as two space-separated values.
